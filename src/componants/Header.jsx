...
const Header = () => {
  ...
  const { connectWallet, userAddress, setWeb3, setUserAddress } = useContext(WalletContext);

  // useEffect(() => {
  //   const restoreWallet = () => {
  //     const storedUserAddress = localStorage.getItem("userAddress");
  //     const storedWeb3Provider = localStorage.getItem("web3Provider");

  //     if(!storedUserAddress && !storedWeb3Provider) {
  //       const web3Instance = new Web3(storedWeb3Provider);
